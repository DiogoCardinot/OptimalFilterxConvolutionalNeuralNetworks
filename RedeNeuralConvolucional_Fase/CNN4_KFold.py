...
"""
CNN Architecture: MoreFilters_64-32
- Input: (7, 1) - Reshape from 7 features
- Conv1D: 64 filters, kernel_size=3, ReLU, same padding  ← 64 FILTERS
- BatchNormalization
- Conv1D: 32 filters, kernel_size=2, ReLU, same padding  ← 32 FILTERS
- BatchNormalization
- Flatten
- Dense: 32 units, ReLU
- Dropout: 0.3
...
dataset_output = os.path.join(path, f"CNN_4",  f'janelamento_{N_JANELAMENTO}')
