...
"""
CNN Architecture: LeakyReLUActivation_32-16
- Input: (7, 1) - Reshape from 7 features
- Conv1D: 32 filters, kernel_size=3, LeakyReLU, same padding
- BatchNormalization
- Conv1D: 16 filters, kernel_size=2, LeakyReLU, same padding
- BatchNormalization
- Flatten
...
dataset_output = os.path.join(path, f"CNN_7",  f'janelamento_{N_JANELAMENTO}')
